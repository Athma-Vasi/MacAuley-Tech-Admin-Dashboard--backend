    ...
    try {
        ...
        const incompleteBusinessMetrics = await Promise.all(
            storeLocations.map(async (storeLocation) => {
                ...
                const [productMetrics, repairMetrics, customerMetrics] =
                    await Promise
                        .all([
        ...
        setTimeout(() => {
            ...
            >(
                (productMetricsAcc, productMetric) => {
                    ...
                    const PRODUCT_METRIC_TEMPLATE_MONTHLY:
                        ProductMonthlyMetric = {
                            month: "January",
                            unitsSold: {
                                inStore: 0,
                    ...
                    const aggregatedYearlyProductMetrics = yearlyMetrics.map(
                        (productYearlyMetric) => {
                            ...
                            const aggregatedYearlyMetric = {
                                ...
                                revenue: {
                                    ...
                                    total: existingYearlyMetric.revenue.total +
                                        revenue.total,
                                    online:
                                        existingYearlyMetric.revenue.online +
                                        revenue.online,
                                    inStore:
                                        existingYearlyMetric.revenue.inStore +
                                        revenue.inStore,
                                },
                                unitsSold: {
                                    ...existingYearlyMetric.unitsSold,
                                    total:
                                        existingYearlyMetric.unitsSold.total +
                                        unitsSold.total,
                                    online:
                                        existingYearlyMetric.unitsSold.online +
                                        unitsSold.online,
                                    inStore:
                            ...
                            const aggregatedMonthlyProductMetrics =
                                monthlyMetrics.map(
                                    (productMonthlyMetric) => {
                                        const {
                                            month,
        ...
        setTimeout(() => {
            ...
            const {
                ...
                switch (storeLocation) {
                    case "Calgary": {
                        productMetricsAcc.calgaryProductMetrics =
                            productMetrics;
                        break;
                    }
                    case "Edmonton": {
                        productMetricsAcc.edmontonProductMetrics =
                            structuredClone(
                                productMetrics,
                            );
                        break;
                    ...
                    // case "Vancouver"
                    default: {
                        productMetricsAcc.vancouverProductMetrics =
                            productMetrics;
                        break;
                    }
                }
                ...
                return storeProductMetrics.reduce<ProductMetric[]>(
                    (baseProductMetricsAcc, storeProductMetric) => {
                        ...
                        yearlyMetrics.forEach((storeYearlyMetric) => {
                            ...
                            baseYearlyMetric.revenue.total +=
                                yearlyRevenue.total;
                            baseYearlyMetric.revenue.online +=
                                yearlyRevenue.online;
        ...
        setTimeout(() => {
            ...
            const aggregatedRepairMetrics = repairMetrics.reduce<RepairMetric>(
                (repairMetricsAcc, repairMetric) => {
                    ...
                    const aggregatedYearlyRepairMetrics = yearlyMetrics.map(
                        (repairYearlyMetric) => {
                            ...
                            const aggregatedYearlyMetric = {
                                ...
                                unitsRepaired:
                                    existingYearlyMetric.unitsRepaired +
                                    unitsRepaired,
                            };

                            const aggregatedMonthlyRepairMetrics =
                                monthlyMetrics.map(
                                    (repairMonthlyMetric) => {
                                        const {
                                            month,
                    ...
                    repairMetricsAcc.yearlyMetrics =
                        aggregatedYearlyRepairMetrics;
        ...
        setTimeout(() => {
            ...
            const {
                ...
                switch (storeLocation) {
                    ...
                    case "Edmonton": {
                        repairMetricsAcc.edmontonRepairMetrics =
                            structuredClone(
                                repairMetrics,
                            );
                        break;
                ...
                return storeRepairMetrics.reduce<RepairMetric[]>(
                    (baseRepairMetricsAcc, storeRepairMetric) => {
                        ...
                        yearlyMetrics.forEach((storeYearlyMetric) => {
                            ...
                            baseYearlyMetric.unitsRepaired +=
                                yearlyUnitsRepaired;
                                ...
                                const dailyCustomersMetrics = daysRange.map(
                                    (day) => {
                                        ...
                                        const dailyReturningCustomersRepairFraction =
                                            Math.random() * (0.15 - 0.05) +
                                            0.05;
                                        const dailyReturningCustomersRepair =
                                            Math.round(
                                        ...
                                        const dailyReturningCustomersOnlineFraction =
                                            Math.random() * (0.9 - 0.7) + 0.7;
                                        const dailyReturningCustomersOnline =
                                            Math.round(
                        ...
                        .reduce(
                            (
                                ...
                                yearlyCustomersMetricsAcc.customers.new
                                    .repair +=
                                        monthlyCustomersMetric.customers.new
                                            .repair;
    ...
    return new Promise((resolve) => {
        setTimeout(() => {
            ...
            const {
                ...
                switch (storeLocation) {
                    case "Calgary": {
                        customerMetricsAcc.calgaryCustomerMetrics =
                            customerMetrics;
                        break;
                    }
                    case "Edmonton": {
            ...
            function aggregateStoresIntoBaseCustomerMetrics({
                ...
                return yearlyMetrics.reduce<CustomerMetrics>(
                    (baseCustomerMetricsAcc, storeCustomerMetric) => {
                        ...
                        baseYearlyMetric.customers.new.total +=
                            newCustomers.total;
            ...
            return new Promise<[StoreLocation, YearlyFinancialMetric[]]>(
                (resolve) => {
                    setTimeout(async () => {
                        ...
                        const { productMetrics, repairMetrics } =
                            businessMetric;
                        ...
                        const allProductsCategory = productMetrics.find(
                            (productMetric) =>
                                productMetric.name === "All Products",
                        );
                            ...
                            Array.from(daysInMonthsInYears).map(
                                async (yearTuple) => {
                                    return new Promise<YearlyFinancialMetric>(
                                        (resolve_) => {
                                            setTimeout(() => {
                                                const [year, daysInMonthsMap] =
                                                    yearTuple;

                                                const yearlyProductMetrics =
                                                    allProductsCategory
                                                        .yearlyMetrics.find(
                                                            (
                                                                yearlyProductMetric,
